  ...
  return (
    <article className="reading-frame space-y-5 sm:space-y-8">
      ...
      <div className="grid gap-5 sm:gap-6 lg:grid-cols-[minmax(0,1fr)_clamp(16rem,26vw,19rem)]">
        ...
        <aside className="space-y-4 self-start sm:space-y-5 lg:sticky lg:top-5">
          {tableOfContents.length > 0 ? (
            <Card className="glass-panel border border-black/10 shadow-[0_18px_60px_rgba(75,54,34,0.08)]">
              <CardBody className="gap-4 p-4 sm:p-5">
                ...
                <nav aria-label="文章目录" className="max-h-[20rem] overflow-y-auto pr-1 sm:max-h-[24rem] lg:max-h-[calc(100svh-5rem)]">

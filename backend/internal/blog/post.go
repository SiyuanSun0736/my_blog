...
type Post struct {
	...
	SearchScore   *float64       `json:"searchScore,omitempty" bson:"score,omitempty"`
	SearchMode    string         `json:"searchMode,omitempty" bson:"-"`
	SearchSnippet *SearchSnippet `json:"searchSnippet,omitempty" bson:"-"`
}
